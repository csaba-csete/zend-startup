...
class Bootstrap extends Zend_Application_Bootstrap_Bootstrap
{
    ...
    public function _initAutoloaderNamespaces()
    {
        ...
        $autoloader->pushAutoloader(
            array($fmmAutoloader, 'loadClass'), 'Doctrine\DBAL\Migrations'
        );
    }
    ...
    public function _initModuleLayout()
    {
        ...
        $front = Zend_Controller_Front::getInstance()->registerPlugin($errorHandler);
    }

    public function _initServices()
    {
        $serviceContainer = new sfServiceContainerBuilder();
        $loader = new sfServiceContainerLoaderFileXml($serviceContainer);
        $loader->load(APPLICATION_PATH . "/configs/services.xml");
        Zend_Registry::set('sc', $serviceContainer);
    }
    ...
    {
        $elasticSearch = new Elastica_Client();
        Zend_Registry::set('es', $elasticSearch);
    }
